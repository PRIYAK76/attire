  ...
  return (
    <Layout>
      ...
      <div className="hero-section-main-1 mt-3">
        ...
        <img class="herosection-image3" src={Herosectionimg3} alt="herosection-ie3" />
        </div>
      </div>
      ...
      <div className=" container mt-3">
          ...
          <img src={Mainbanner} className="home-page-image-background container" alt="home-page-backgroundcontainer"/>
